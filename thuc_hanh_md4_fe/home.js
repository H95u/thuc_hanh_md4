...
<td><textarea>${city.description}</textarea></td>
<td><button class="btn btn-info" onclick="showInforPage(${city.id})" >Xem</button></td>
<td><button onclick="deleteCity(${city.id})" class="btn btn-danger">Xóa</button></td>
<td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#updateModal" onclick="showUpdateForm(${city.id})">Sửa</button></td>
</tr>`
}
...
function showAll() {
    $.ajax({
        ...
        success: function (data) {
            let content = `<table class="table table-bordered border-primary" style="width: 1000px;margin: auto;text-align: center">
<tr>
<td>ID</td>
<td>Tên</td>
<td>Quốc gia</td>
...
function showOne() {
    ...
    $.ajax({
        ...
        url: `http://localhost:8080/api/cities/` + id,
        success: function (data) {
            let content = `<table class="table" style="width: 600px;margin: auto">
           <tr>
           <td>Tên</td>
           <td>${data.name}</td>
           </tr>
           ...
           <td><textarea>${data.description}</textarea></td>
             ...
             <tr>
            <td><button class="btn btn-info" onclick="backToHome()">Về trang chủ</button></td>
           </tr>
    </table>`
